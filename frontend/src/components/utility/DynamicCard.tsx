...
const DynamicCard: React.FC<DynamicCardProps> = ({
  ...
  return (
    <div className="group relative w-full max-w-sm h-[26rem] rounded-2xl shadow-2xl shadow-black overflow-hidden transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
      {/* Background Image  */}
      <div
