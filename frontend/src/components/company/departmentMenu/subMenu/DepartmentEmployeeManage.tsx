...
const tempLogo = "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=50&h=50&fit=crop";
                ...
                <div className="flex justify-center">
                  <Sheet>
                    ...
                    <SheetContent className="bg-gray-600 border-none text-center text-white ">
                      <SheetHeader>
                        <SheetTitle className="text-center mt-8"> Employee Details</SheetTitle>
                        <SheetDescription className="text-center">View employee information</SheetDescription>
                      </SheetHeader>

                      <div className="mt-6 flex flex-col justify-center items-center ">
                        <img src={tempLogo} alt="company dp" className="rounded-full w-20 h-20" />
                        <h3 className="text-lg font-bold mt-1">{employee.name.toUpperCase()}</h3>
                        ...
                        <div className="mt-3 space-y-4">
                          ...
                          <div>
                            <label className="text-sm font-semibold underlin">Contact Details</label>
                            <div className="flex justify-center items-center gap-2">
                              <MdOutlineEmail />
                              <p className="mt-1 text-blue-500 underline">{employee.email}</p>
                            </div>
