        ...
        <header>
          ...
          <div className="mt-4 shadow-2xl p-2 bg-white rounded-lg mx-8 h-1/4">
            <div className=" ms-4 flex items-center gap-2 justify-evenly p-2">
              ...
              <div>
                <button
                  onClick={ () => navigate("/company/dashboard/purchase-history") }
                  className=" flex items-center gap-1  text-blue-600 text-sm font-semibold underline underline-offset-1  hover:text-orange-500">
                  {" "}
                  View purchase history
                  <FaFileAlt className="text-lg text-black" />
                </button>
              </div>
            </div>
